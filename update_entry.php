...
<?php
		...
		$iconImage = mysqli_real_escape_string($conn, $iconImage);
		$vtags = mysqli_real_escape_string($conn, $vtags);
		...
		$sql = "UPDATE fun_video ".
   	   	...
   	   	" viewcount = '$vcount', videotype = '$vtype', tag = '$vtags', videolink = '$videoLink', iconimage = '$iconImage', category = '$cat' ".
   	   	" WHERE id = '$id' ";
